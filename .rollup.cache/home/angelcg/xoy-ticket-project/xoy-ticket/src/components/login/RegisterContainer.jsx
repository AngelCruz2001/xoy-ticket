...
export const RegisterContainer = ({ setIsRegistered }) => {
    const dispatch = useAppDispatch();
    return (<div className="loginContainer__card__leftside">
            <div className="loginContainer__card__leftside__logo">
                <img src={logoWColor} alt="logo"/>
            </div>
            <h2 className="loginContainer__card__leftside__title">
            ...
            dispatch(startSignUp({
                ...
                {({ errors, touched }) => (<Form>
                        <div className='field'>
                            <Field name="name" placeholder='Introduce tu nombre' className="input"/>
                            <ErrorMessage name="name" component="span" className="error"/>
                        </div>
                        <div className='field'>
                            <Field name="folio" placeholder='Introduce tu folio' className="input" type="number"/>
                            <ErrorMessage name="folio" component="span" className="error"/>
                        </div>
                        <div className='field'>
                            <Field name="email" placeholder='Introduce tu correo electronico' className="input"/>
                            <ErrorMessage name="email" component="span" className="error"/>
                        </div>
                        <div className='field'>

                            <Field type="password" name="password" placeholder='Introduce tu contraseña' className="input"/>
...
//# sourceMappingURL=RegisterContainer.jsx.map