...
export const DocumentPdf = ({ qr, dataUser, ventaDatos, juego }) => {
    // const dataUser = {
    ...
    return (<Document title="Boletos">
            ...
            justifyContent: 'center',
                    ...
                    <View style={styles.brands}>
                        ...
                        {brands.map((brand, index) => (<Image key={index} src={brand} style={{}}/>))}
                    </View>
                </View>
                <View style={styles.body}>
                    ...
                    <View style={styles.body__leftside}>
                        ...
                        <View style={styles.imageContainer}>
                            <Image src={xoy} style={styles.image}/>
                        </View>
                ...
                <View style={styles.additional}>
                    <View style={styles.addleftside}>
                        ...
                        <View style={styles.addImgContainer}>
                            <Image src={promo} style={styles.addImg}/>
                        </View>
                    </View>
...
//# sourceMappingURL=DocumentPdf.jsx.map